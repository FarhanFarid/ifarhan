var table_mscvomit = $('#report-mscvomit-table').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Report Miscellaneous - Vomit Chart',
            className: 'btn-dark',
        },
    ],
    columnDefs: [
    ...
    ajax: {
        ...
        dataSrc: "vomit",
        data: function (d) {
            d.dateRange = $('#filterdatemscvomit').val();
        },
        dataType: "json",
    },
});
...
$(document).ready(function() {
    $('#filterdatemscvomit').daterangepicker({
        locale: {
            format: 'DD/MM/YYYY'
        },
    }).on('apply.daterangepicker', function(ev, picker) {
        table_mscvomit.ajax.reload(); 
    });
});