...
<div class="row">
    <div class="col-md-12 mb-2">
        <div class="card card-custom gutter-b" style="border-radius: 0px !important; background-color: #e9f2ff;">
            <h4 style="padding: 0.5rem !important; margin-bottom: 0px !important; color: #1d69e3;">Consent Listing</h4>
        </div>
        <div class="card-body">
                        ...
                        <table class="table table-bordered table-row-bordered" id="reportms-table">
                            <thead class="thead-light">
                                <tr class="fw-semibold fs-6">
                                    ...
                                    <th style="min-width: 50px; color: #14787c; background-color:#ecfefe">Created Time</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script>
    ...
    var config = {
        routes: {
            point : {
                ms : {
                    data: "{{ route('report.consent.list') }}?{!! $url !!}",
                }
            }
        }
    }
</script>
<script src="{{ asset('js/ireporting/consent.js') }}"></script>
@endpush