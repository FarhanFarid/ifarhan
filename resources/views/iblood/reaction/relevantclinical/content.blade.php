<form id="relevantclinicalform">
    @csrf
    <div class="row mb-3 d-flex align-items-stretch">
        <div class="col-md-12 d-flex flex-column">
            @include('iblood.reaction.relevantclinical.subviews.history')
        </div>
    </div>
</form>
<div style="text-align: center;">
    <button type="button" class="btn btn-primary font-weight-bold save-relevantclinical mt-2">{{__('SAVE')}}</button>
    <button type="button" class="btn btn-dark font-weight-bold clear-relevantclinical mt-2">{{__('CLEAR')}}</button>
</div>
...
@push('script')
    ...
    <script src="{{ asset('js/iblood/relevantclinical.js') }}"></script>
@endpush