...
<!-- end nav ida --> --}}
<div class="row {{ request()->routeIs('bm.index') ? 'bg-teal' : '' }}" style="padding: 0.5rem; margin: auto; border-bottom: solid 1px #cccccc;">
	<div class="col-2 mt-2">
		<a class="text-hover-success {{ request()->routeIs('bm.index') ? 'display-none' : 'display-block' }}" href="#" id="expandhr" style="margin-bottom: 10px; display: block;">
			<i class="fas fa-angle-right fs-3 {{ request()->routeIs('bm.index') ? 'color-white' : 'color-teal' }}" style="float: right; margin-bottom: 10px; color: #14787c;"></i>
		</a>
	</div>
