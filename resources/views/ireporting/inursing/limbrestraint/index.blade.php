...
<div class="row">
    <div class="col-md-12 mb-2">
        <div class="card card-custom gutter-b" style="border-radius: 0px !important; background-color: #e9f2ff;">
            <h4 style="padding: 0.5rem !important; margin-bottom: 0px !important; color: #1d69e3;">iNursing: Limb Restraint Assessment & Reassessment</h4>
        </div>
        <div class="card-body">
...
<script src="{{ asset('js/ireporting/inursing/limbrestraintreport.js') }}"></script>
@endpush