...
<div class="card card-custom gutter-b" style="box-shadow: 0px 2px 6px 2px #dcdcdc !important; border-radius: 0px !important; border-top: solid 3px #1d69e3 !important;">
    <div class="card-body" style="padding: 0.75rem !important;">
        <div class="row">
            <div class="col-3">
                <b>NAME</b>: <span id="patientinfoname"></span>
                <br />
            ...
            <div class="col-2">
                ...
                <br />
                <b>Epsiode Date</b>: <span id="patientinfoepsnumdate"></span>
            </div>
            <div class="col-3">
            ...
            <div class="col-2">
                ...
                <br />
                <b>BMI</b>: <span id="patientinfobmi"></span>
                <br />
                <b>BSA</b>: <span id="patientinfobsa"></span>
            </div>
        </div>
    </div>
</div>