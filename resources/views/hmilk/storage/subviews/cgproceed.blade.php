<div class="modal fade modal-md" tabindex="-1" id="cgproceed-milk" style="">
                                    ...
                                    <div class="col-md-12" style="box-shadow: 0px 2px 6px 2px #dcdcdc !important;">
                                        ...
                                        <div class="card-body">
                                            <div class="row m-1">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control" type="text" name="cgepisdno" id="cgepisdno" readonly>
                                                </div>
                                            </div>
                                            <div class="row m-1">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control" type="text" name="cgbchId" id="cgbchId" readonly>
                                                </div>
                                            </div>
                                            <div class="row m-1">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-select form-select-solid" aria-label="Select example" name="cgremarks" id="cgremarks">
                                        ...
                                        <button type="button" id="cgupdateProceed" class="align-self-end btn btn-success btn-sm font-weight-bold btn-block mt-3 mb-3" style="margin-top: auto;">{{__('PROCEED')}}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
