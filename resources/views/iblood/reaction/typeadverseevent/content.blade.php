<form id="typeadverseeventform">
    @csrf
    <div class="row mb-3 d-flex align-items-stretch">
        <div class="col-md-12 d-flex flex-column">
            @include('iblood.reaction.typeadverseevent.subviews.events')
        </div>
    </div>
</form>
<div style="text-align: center;">
    <button type="button" class="btn btn-primary font-weight-bold save-typeadverseevent mt-2">{{__('SAVE')}}</button>
    <button type="button" class="btn btn-dark font-weight-bold clear-typeadverseevent mt-2">{{__('CLEAR')}}</button>
</div>
...
@push('script')
    ...
    <script src="{{ asset('js/iblood/typeadverseevent.js') }}"></script>
@endpush