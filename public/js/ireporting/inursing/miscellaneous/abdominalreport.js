var table_mscabdominal = $('#report-mscabdominal-table').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Report Miscellaneous - Abdominal Girth',
            className: 'btn-dark',
        },
    ],
    columnDefs: [
    ...
    ajax: {
        ...
        dataSrc: "abdominal",
        data: function (d) {
            d.dateRange = $('#filterdatemscabdominal').val();
        },
        dataType: "json",
    },
});
...
$(document).ready(function() {
    $('#filterdatemscabdominal').daterangepicker({
        locale: {
            format: 'DD/MM/YYYY'
        },
    }).on('apply.daterangepicker', function(ev, picker) {
        table_mscabdominal.ajax.reload(); 
    });
});