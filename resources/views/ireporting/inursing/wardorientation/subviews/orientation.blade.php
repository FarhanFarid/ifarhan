<div class="row mb-5">
    <div class="col-md-4 mb-3">
        <div class="form-group">
            ...
            <div class="fv-row">
                <input class="form-control form-control-md" placeholder="Pick date range" id="filterdatewoorientation" value="{{ \Carbon\Carbon::now()->format('d/m/Y') }} - {{ \Carbon\Carbon::now()->format('d/m/Y') }}" readonly/>
            </div>
        </div>
    </div>
</div>
<table class="table table-bordered table-row-bordered" id="report-woorientation-table">
    <thead class="thead-light">
        <tr class="fw-semibold fs-6 text-center">
            ...
            <th style="min-width: 100px; color: #14787c; background-color:#ecfefe; vertical-align: top;">Ward</th>                               
