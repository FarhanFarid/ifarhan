<form id="outcomeadverseform">
    @csrf
    <div class="row mb-3 d-flex align-items-stretch">
        <div class="col-md-12 d-flex flex-column">
            @include('iblood.reaction.outcomeadverseevent.subviews.recovered')
        </div>
    </div>
    <div class="row mb-3 d-flex align-items-stretch">
        <div class="col-md-12 d-flex flex-column">
            @include('iblood.reaction.outcomeadverseevent.subviews.death')
        </div>
    </div>
</form>
<div style="text-align: center;">
    <button type="button" class="btn btn-primary font-weight-bold save-outcomeadverse mt-2">{{__('SAVE')}}</button>
    <button type="button" class="btn btn-dark font-weight-bold clear-outcomeadverse mt-2">{{__('CLEAR')}}</button>
</div>
...
@push('script')
    ...
    <script src="{{ asset('js/iblood/adverseeventoutcome.js') }}"></script>
@endpush