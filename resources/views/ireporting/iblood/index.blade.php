                        ...
                        <table class="table table-bordered table-row-bordered" id="reportiblood-table">
                            <thead class="thead-light">
                                <tr class="fw-semibold fs-6">
                                    ...
                                    <th style="min-width: 40px; color: #14787c; background-color:#ecfefe">Name</th>
                                    <th style="min-width: 30px; color: #14787c; background-color:#ecfefe">Episode No.</th>
                                    <th style="min-width: 50px; color: #14787c; background-color:#ecfefe">LB No.</th>
                                    <th style="min-width: 100px; color: #14787c; background-color:#ecfefe">Bag No.</th>
                                    <th style="min-width: 100px; color: #14787c; background-color:#ecfefe">Bag Location</th>
                                    <th style="min-width: 100px; color: #14787c; background-color:#ecfefe">Incident / Reaction</th>
                                    <th style="min-width: 50px; color: #14787c; background-color:#ecfefe">Expiry Date</th>
