var table_mscseizure = $('#report-mscseizure-table').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Report Miscellaneous - Seizure Chart',
            className: 'btn-dark',
        },
    ],
    columnDefs: [
    ...
    ajax: {
        ...
        dataSrc: "seizure",
        data: function (d) {
            d.dateRange = $('#filterdatemscseizure').val();
        },
        dataType: "json",
    },
});
...
$(document).ready(function() {
    $('#filterdatemscseizure').daterangepicker({
        locale: {
            format: 'DD/MM/YYYY'
        },
    }).on('apply.daterangepicker', function(ev, picker) {
        table_mscseizure.ajax.reload(); 
    });
});