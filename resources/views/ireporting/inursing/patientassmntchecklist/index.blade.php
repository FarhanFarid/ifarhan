...
<div class="row">
    <div class="col-md-12 mb-2">
        <div class="card card-custom gutter-b" style="border-radius: 0px !important; background-color: #e9f2ff;">
            <h4 style="padding: 0.5rem !important; margin-bottom: 0px !important; color: #1d69e3;">iNursing: Patient Assessment Checklist for Home Inotropes</h4>
        </div>
        <div class="card-body">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="fv-row">
                                        <input class="form-control form-control-md" placeholder="Pick date range" id="filterdatepatientassmtchecklist" value="{{ \Carbon\Carbon::now()->format('d/m/Y') }} - {{ \Carbon\Carbon::now()->format('d/m/Y') }}" readonly/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-row-bordered" id="report-patientassmtchecklist-table">
                            <thead class="thead-light">
                                <tr class="fw-semibold fs-6 text-center">
                                    ...
                                    <th style="min-width: 100px; color: #14787c; background-color:#ecfefe; vertical-align: top;">MRN</th>
                                    ...
                                    <th style="min-width: 100px; color: #14787c; background-color:#ecfefe; vertical-align: top;">Responsible Guardian/Caretaker</th>
...
<script>
    ...
    var config = {
        routes: {
            ireporting : {
                patientassmtchecklist : {
                    data: "{{ route('report.inursing.patientassmtchecklist.getdatapatientassmtchecklist') }}?{!! $url !!}",
                }
            }
        }
    }
</script>
<script src="{{ asset('js/ireporting/inursing/patientassmtchecklistreport.js') }}"></script>
@endpush