...
@section('content')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="row">
                                                                <b class="text-white">Chiller: {{$totalebmChiller}}</b>
                                                            </div>  
                                                            <div class="row">
                                                                <b class="text-white">Freezer: {{$totalebmFreezer}}</b>
                                                            </div>  
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="row">
        <div class="col-md-12 mb-2">
            <div class="card card-custom gutter-b" style="border-radius: 0px !important; background-color: #e9f2ff;">
                <h4 style="padding: 0.5rem !important; margin-bottom: 0px !important; color: #1d69e3;">EBM ADMINISTER BARCODE</h4>
            </div>
            <div class="card-body">
                <div class="card card-custom gutter-b" style="box-shadow: 0px 2px 6px 2px #dcdcdc !important; border-radius: 0px !important; border-top: solid 3px #1d69e3 !important;">
                    <form id="#">
    ...
    <div class="row">
        <div class="col-md-12 mb-2">
            <div class="card card-custom gutter-b" style="border-radius: 0px !important; background-color: #e9f2ff;">
                <h4 style="padding: 0.5rem !important; margin-bottom: 0px !important; color: #1d69e3;">EBM ADMINISTER RECEIVE</h4>
            </div>
            <br/>
            <div class="card-body">
    ...
    <script>
        ...
        var config = {
                routes: {
                    hmilk :{
                        administer : {
                            check: "{{ route('hmilk.administer.detail') }}?{!! $url !!}",
                            submit: "{{ route('hmilk.administer.submit') }}?{!! $url !!}",
                        },
                    },         
                }
            };
    </script>
    <script src="{{ asset('js/hmilk/administer.js') }}"></script>
@endpush