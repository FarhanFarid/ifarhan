var table_mschypercyanotic = $('#report-mschypercyanotic-table').DataTable({
    ...
    buttons: [
        {
            extend: 'excel',
            title: 'Report Miscellaneous - Hypercyanotic Spell',
            className: 'btn-dark',
        },
    ],
    columnDefs: [
    ...
    ajax: {
        ...
        dataSrc: "hyper",
        data: function (d) {
            d.dateRange = $('#filterdatemschypercyanotic').val();
        },
        dataType: "json",
    },
});
...
$(document).ready(function() {
    $('#filterdatemschypercyanotic').daterangepicker({
        locale: {
            format: 'DD/MM/YYYY'
        },
    }).on('apply.daterangepicker', function(ev, picker) {
        table_mschypercyanotic.ajax.reload(); 
    });
});