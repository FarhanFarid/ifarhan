<form id="relevantinvestigationform">
    @csrf
    <div class="row mb-3 d-flex align-items-stretch">
        <div class="col-md-12 d-flex flex-column">
            @include('iblood.reaction.relevantinvestigation.subviews.investigation')
        </div>
    </div>
</form>
<div style="text-align: center;">
    <button type="button" class="btn btn-primary font-weight-bold save-relevantinvestigation mt-2">{{__('SAVE')}}</button>
    <button type="button" class="btn btn-dark font-weight-bold clear-relevantinvestigation mt-2">{{__('CLEAR')}}</button>
</div>
...
@push('script')
    ...
    <script src="{{ asset('js/iblood/relevantinvestigation.js') }}"></script>
@endpush