<form id="bloodcomponentform">
    @csrf
    <div class="row mb-3 d-flex align-items-stretch">
        <div class="col-md-12 d-flex flex-column">
            @include('iblood.reaction.bloodcomponent.subviews.component')
        </div>
    </div>
</form>
<div style="text-align: center;">
    <button type="button" class="btn btn-primary font-weight-bold save-bloodcomponent mt-2">{{__('SAVE')}}</button>
    <button type="button" class="btn btn-dark font-weight-bold clear-bloodcomponent mt-2">{{__('CLEAR')}}</button>
</div>
...
@push('script')
    ...
    <script src="{{ asset('js/iblood/bloodcomponent.js') }}"></script>
@endpush